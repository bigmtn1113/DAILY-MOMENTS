...
<div id="notice" class="about-me mobileList">
			...
			<form id="noticeList" class="php-email-form mt-4">	<!-- qnaList 불러올 때 이 밑에 있는거 대체해서 이 자리에 넣는 거임. 이 아래 양식에 넣는 게 아니라, 대체하는 것! -->		
				<table  style="color:#636568; width:100%; border-collapse: separate; border-spacing: 5px;">
					<tr style="height: 30px; background-color: white;" align="center">
						...
						<th class="mobileCase" style="width:00px; background-color: #262626; padding-left: 0px;  padding-bottom: 10px; padding-top: 10px;">ID</th>
						<th class="mobileCase" style="width:00px; background-color: #262626; padding-left: 0px;  padding-bottom: 10px; padding-top: 10px;">Date</th>
					</tr>
