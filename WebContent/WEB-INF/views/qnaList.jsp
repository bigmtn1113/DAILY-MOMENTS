...
<table style="color:#636568; width:100%; border-collapse: separate; border-spacing: 5px;">
	<tr style="height: 30px; background-color: white;" align="center">
		...
		<th class="mobileCase"  style="width:0px; background-color: #262626; padding-bottom: 10px; padding-top: 10px; padding-left: 0px;">ID</th>
		<th class="mobileCase"  style="width:0px; background-color: #262626; padding-bottom: 10px; padding-top: 10px; padding-left: 0px;">Date</th>
	</tr>
	...
	<c:forEach var="board" items="${list}">
		<tr align="center">
			...
			<td class="mobileCase" style="background-color: #262626; padding-bottom: 10px; padding-top: 10px; padding-left: 0px">${board.mid}</td>
			<%-- <td><img class="rounded-circle" width="50px" height="50px" src="photodownload?fileName=${board.mphoto}"/></td> --%>
			<td class="mobileCase" style="background-color: #262626; padding-bottom: 10px; padding-top: 10px; padding-left: 0px"><fmt:formatDate value="${board.bdate}" pattern="yyyy-MM-dd"/></td>
		</tr>
	</c:forEach>
