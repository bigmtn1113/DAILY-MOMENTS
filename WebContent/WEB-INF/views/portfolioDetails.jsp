			...
			<div class="portfolio-details">
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-8">
							<div>
								<a href="#" style="text-decoration: none; color: white; font-size: 30px;">${mid}</a>
							</div>
							<div class="owl-carousel portfolio-details-carousel">
								<img src="<%=request.getContextPath()%>/resources/assets/img/portfolio/portfolio-details-1.jpg" style='width: 100%'>
							</div>
						</div>
						...
						<div class="col-lg-4 portfolio-info">
							...
							<div style="height: 40px; margin-bottom: 5px">
								...
								<button type="button" style="float: left; border: none; outline: none; background: none;">
									<img onclick="changeHeartImg();" id="img-heart" src="<%=application.getContextPath()%>/resources/assets/img/need/heart.png">
								</button>
								<script>
								...
								<button type="button" style="float: right; border: none; outline: none; background: none;">
									<img onclick="changeBookmarkImg();" id="img-bookmark" src="<%=application.getContextPath()%>/resources/assets/img/need/bookmark.png">
								</button>
								<script>
